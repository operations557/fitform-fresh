    ...
    <section className="relative min-h-screen flex items-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-10 grid md:grid-cols-12 gap-12 items-center w-full">
        <div className="md:col-span-7">
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.45, duration: 0.5 }} className="mt-8 max-w-lg text-brand-white/70 text-lg leading-relaxed">22 premium-grade supplements. Engineered for athletes who don&apos;t negotiate with results.</motion.p>
